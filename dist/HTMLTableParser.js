...
exports.HTMLTableParser = void 0;
class TableHandler {
...
class HTMLTableParser {
    constructor({ tableSelectors = ['table'], rowSelectors = ['tr'], removePreserving = ['thead', 'tbody'], cellSelectors = ['td', 'th'], alwaysRemove = ['head'] }) {
...
exports.HTMLTableParser = HTMLTableParser;
...
curl 'https://secure.alpsinc.com/MarketingAPI/api/v1/holding/USL' \
  ...
  --compressed
  */ 
//# sourceMappingURL=HTMLTableParser.js.map