...
declare module 'csv-parse/lib/browser' {
    ...
    function parse(input: Buffer | string, callback?: parse.Callback): parse.Parser;
    function parse(options?: parse.Options, callback?: parse.Callback): parse.Parser;
    function parse(callback?: parse.Callback): parse.Parser;
    interface parseWithCb {
        (input: Buffer | string, options?: parse.Options, callback?: parse.Callback): parse.Parser;
        (input: Buffer | string, callback?: parse.Callback): parse.Parser;
        (options?: parse.Options, callback?: parse.Callback): parse.Parser;
        (callback?: parse.Callback): parse.Parser;
    }
