...
import type { NODE_STREAM_INPUT, PapaConfig, ParseError, ParseMeta, ParseResult } from 'papaparse';
import { default as PapaDefault, Parser, ParserHandle } from 'papaparse';
...
var Papa = {
	...
	parse: (
	...
	): ParseResult<any> | Promise<ParseResult<any>> | NodeJS.ReadWriteStream => {
		_config = _config || {};
		...
		return PapaDefault.parse(_input as unknown as typeof NODE_STREAM_INPUT, _config as PapaDefault.ParseConfig)
